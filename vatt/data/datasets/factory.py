...
from vatt.data.datasets import toy_dataset, kinetics400_dataset
...
DS_TO_FACTORY = {
    ...
    'KINETICS400': kinetics400_dataset.KineticFactory
}


def get_ds_factory(dataset_name='kinetics400',
                   override_args=None):
